...
_TEXT	SEGMENT
$T29832 = -10724					; size = 24
$T29833 = -10692					; size = 4
_buffer$25472 = -10488					; size = 10240
_len$25471 = -240					; size = 4
_source_str$ = -228					; size = 4
_size$ = -216						; size = 4
_f$ = -204						; size = 184
...
; 46   : {
	...
	push	eax
	mov	eax, 10716				; 000029dcH
	call	__chkstk
	push	ebx
	push	esi
	push	edi
	lea	edi, DWORD PTR [ebp-10728]
	mov	ecx, 2679				; 00000a77H
	mov	eax, -858993460				; ccccccccH
	rep stosd
...
; 105  : 	char *source_str = new char[size];
	...
	add	esp, 4
	mov	DWORD PTR $T29833[ebp], eax
	mov	ecx, DWORD PTR $T29833[ebp]
	mov	DWORD PTR _source_str$[ebp], ecx
...
; 123  : 		                      sizeof(buffer), buffer, &len);
	...
	lea	eax, DWORD PTR _len$25471[ebp]
	push	eax
	lea	ecx, DWORD PTR _buffer$25472[ebp]
	push	ecx
...
; 125  : 		printf("Error: failed to create program executable\n%s\n", buffer);
	...
	lea	eax, DWORD PTR _buffer$25472[ebp]
	push	eax
...
$LN11@cl_build_p:
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN19@cl_build_p
...
_state_ptr$ = 12					; size = 4
_state_length$ = 16					; size = 4
_roundkeys_length$ = 20					; size = 4
...
_TEXT	SEGMENT
_roundkeys$ = 8						; size = 4
_rk_length$ = 12					; size = 4
_text$ = 16						; size = 4
_text_length$ = 20					; size = 4
...
; 716  : 			const streamsize _Num = _Myios::rdbuf()->sgetn(_Str, _Count);
	...
	mov	DWORD PTR __Num$25938[ebp], eax
	mov	ecx, DWORD PTR tv155[ebp+4]
	mov	DWORD PTR __Num$25938[ebp+4], ecx

; 717  : 			_Chcount += _Num;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	add	ecx, DWORD PTR __Num$25938[ebp]
	mov	edx, DWORD PTR [eax+12]
	adc	edx, DWORD PTR __Num$25938[ebp+4]
	mov	eax, DWORD PTR _this$[ebp]
...
; 718  : 			if (_Num != _Count)
	...
	mov	eax, DWORD PTR __Num$25938[ebp]
	cmp	eax, DWORD PTR __Count$[ebp]
	jne	SHORT $LN12@read
	mov	ecx, DWORD PTR __Num$25938[ebp+4]
...
; 1171 : 		{	// construct with named file and specified mode
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T29923[ebp]
	or	eax, 1
	mov	DWORD PTR $T29923[ebp], eax
$LN2@basic_fstr:
	push	0
	mov	eax, DWORD PTR _this$[ebp]
...
__unwindfunclet$??0?$basic_fstream@DU?$char_traits@D@std@@@std@@QAE@PBDHH@Z$0:
	...
	and	eax, 1
	je	$LN6@basic_fstr
	and	DWORD PTR $T29923[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 112				; 00000070H
...
; 359  : 			? _Traits::eof() : _Traits::to_int_type(*_Gninc()));
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T29994[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T29995[ebp], eax
	lea	ecx, DWORD PTR $T29994[ebp]
	push	ecx
	lea	edx, DWORD PTR $T29995[ebp]
	push	edx
...
; 379  : 			else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30004[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30004[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 408  : 				overflow(_Traits::to_int_type(*_Ptr))))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T30017[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30018[ebp], eax
	lea	ecx, DWORD PTR $T30017[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30018[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T30056 = -340						; size = 4
$T30061 = -328						; size = 4
__Count$26339 = -124					; size = 4
__Str$26244 = -112					; size = 32
__Dest$26243 = -72					; size = 4
__Src$26242 = -60					; size = 4
__Ch$26241 = -45					; size = 1
__STRING_INC$26240 = -36				; size = 4
_this$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
__Meta$ = 8						; size = 4
...
; 322  : 		{	// put an element to stream
	...
	mov	DWORD PTR fs:0, eax
	mov	DWORD PTR _this$[ebp], ecx
	mov	DWORD PTR $T30061[ebp], 0

; 323  : 		if (_Traits::eq_int_type(_Traits::eof(), _Meta))

	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30039[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30039[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 339  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$26240[ebp], 8
...
; 340  : 			const _Elem _Ch = _Traits::to_char_type(_Meta);
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR __Ch$26241[ebp], al
...
; 344  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$26244[ebp]
...
; 348  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	eax, DWORD PTR __Dest$26243[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30043[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Str$26244[ebp]
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	lea	edx, DWORD PTR __Src$26242[ebp]
	push	edx
	lea	eax, DWORD PTR __Ch$26241[ebp+1]
	push	eax
	lea	ecx, DWORD PTR __Ch$26241[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR $T30042[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T30044[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T30043[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	ecx, DWORD PTR $T30042[ebp]
...
; 353  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	edx, DWORD PTR __Dest$26243[ebp]
	sub	edx, eax
	mov	DWORD PTR __Count$26339[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T30045[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ

; 354  : 					if (0 < _Count && _Count !=
; 355  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))

	cmp	DWORD PTR __Count$26339[ebp], 0
	jbe	SHORT $LN25@overflow
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+84]
	push	ecx
	mov	edx, DWORD PTR __Count$26339[ebp]
	push	edx
	push	1
	lea	eax, DWORD PTR $T30047[ebp]
	push	eax
	lea	ecx, DWORD PTR __Str$26244[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	edx, DWORD PTR $T30061[ebp]
	or	edx, 1
	mov	DWORD PTR $T30061[ebp], edx
	mov	ecx, DWORD PTR tv246[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$26339[ebp], eax
...
$LN26@overflow:
	...
	mov	BYTE PTR $T30046[ebp], al
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T30061[ebp]
	and	ecx, 1
	je	SHORT $LN35@overflow
	and	DWORD PTR $T30061[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T30047[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN35@overflow:
	movzx	edx, BYTE PTR $T30046[ebp]
	test	edx, edx
...
; 356  : 						return (_Traits::eof());	// write failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30050[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26244[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30050[ebp]
	jmp	$LN21@overflow
$LN8@overflow:
...
; 359  : 					if (_Src != &_Ch)
	...
	mov	eax, DWORD PTR __Src$26242[ebp]
	lea	ecx, DWORD PTR __Ch$26241[ebp]
	cmp	eax, ecx
...
; 367  : 						return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30052[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26244[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30052[ebp]
	jmp	$LN21@overflow
$LN5@overflow:
...
; 373  : 						: _Traits::eof());	// no conversion, put as is
	...
	mov	ecx, DWORD PTR [eax+84]
	push	ecx
	movzx	edx, BYTE PTR __Ch$26241[ebp]
	push	edx
	call	??$_Fputc@D@std@@YA_NDPAU_iobuf@@@Z	; std::_Fputc<char>
	add	esp, 8
	movzx	eax, al
...
; 376  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30056[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26244[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30056[ebp]
	jmp	SHORT $LN21@overflow
$LN10@overflow:
...
; 388  : 				_Meta)))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30094[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30094[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T30095[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30095[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 393  : 		else if (_Myfile == 0 || _Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30096[ebp], eax
	lea	eax, DWORD PTR __Meta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30096[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 395  : 		else if (_Pcvt == 0 && _Ungetc(_Traits::to_char_type(_Meta), _Myfile))
	...
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	mov	BYTE PTR $T30097[ebp], al
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+84]
	push	edx
	lea	eax, DWORD PTR $T30097[ebp]
	push	eax
...
; 413  : 		else if (_Traits::eq_int_type(_Traits::eof(), _Meta = uflow()))
	...
	mov	DWORD PTR __Meta$[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30102[ebp], eax
	lea	ecx, DWORD PTR __Meta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30102[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
$T30119 = -352						; size = 4
$T30120 = -340						; size = 4
__Meta$26396 = -136					; size = 4
__Nleft$26395 = -124					; size = 4
__Src$26394 = -112					; size = 4
__Dest$26393 = -100					; size = 4
__Ch$26392 = -85					; size = 1
__Str$26388 = -76					; size = 32
__Ch$26386 = -33					; size = 1
_this$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 435  : 				: _Traits::eof());
	...
	mov	ecx, DWORD PTR [eax+84]
	push	ecx
	lea	edx, DWORD PTR __Ch$26386[ebp]
	push	edx
	...
	lea	ecx, DWORD PTR __Ch$26386[ebp]
	push	ecx
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
...
; 439  : 			string _Str;
	...
	lea	ecx, DWORD PTR __Str$26388[ebp]
...
; 446  : 				int _Meta = fgetc(_Myfile);
	...
	call	_fgetc
	add	esp, 4
	mov	DWORD PTR __Meta$26396[ebp], eax

; 447  : 
; 448  : 				if (_Meta == EOF)

	cmp	DWORD PTR __Meta$26396[ebp], -1
	jne	SHORT $LN11@uflow@2

; 449  : 					return (_Traits::eof());	// partial char?

	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30111[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30111[ebp]
	jmp	$LN19@uflow@2
$LN11@uflow@2:
...
; 451  : 				_Str.append(1, (char)_Meta);	// append byte and convert
	...
	movzx	eax, BYTE PTR __Meta$26396[ebp]
	push	eax
	push	1
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	?append@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEAAV12@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::append
...
; 454  : 					&_Ch, &_Ch + 1, _Dest))
	...
	lea	eax, DWORD PTR __Dest$26393[ebp]
	push	eax
	lea	ecx, DWORD PTR __Ch$26392[ebp+1]
	push	ecx
	lea	edx, DWORD PTR __Ch$26392[ebp]
	push	edx
	lea	eax, DWORD PTR __Src$26394[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30113[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	DWORD PTR $T30112[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T30114[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T30113[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	ecx, DWORD PTR $T30112[ebp]
...
; 458  : 					if (_Dest != &_Ch)
	...
	mov	eax, DWORD PTR __Dest$26393[ebp]
	lea	ecx, DWORD PTR __Ch$26392[ebp]
	cmp	eax, ecx
	je	$LN7@uflow@2
...
; 460  : 						_Nleft = (int)(&*_Str.begin() + _Str.size() - _Src);
	...
	call	?size@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEIXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::size
	add	esi, eax
	sub	esi, DWORD PTR __Src$26394[ebp]
	mov	DWORD PTR __Nleft$26395[ebp], esi
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T30115[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN6@uflow@2:

; 461  : 						for (; 0 < _Nleft; )

	cmp	DWORD PTR __Nleft$26395[ebp], 0
	jle	SHORT $LN5@uflow@2

; 462  : 							ungetc(_Src[--_Nleft], _Myfile);

	mov	eax, DWORD PTR __Nleft$26395[ebp]
	sub	eax, 1
	mov	DWORD PTR __Nleft$26395[ebp], eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+84]
	push	edx
	mov	eax, DWORD PTR __Src$26394[ebp]
	add	eax, DWORD PTR __Nleft$26395[ebp]
...
; 463  : 						return (_Traits::to_int_type(_Ch));
	...
	lea	eax, DWORD PTR __Ch$26392[ebp]
	push	eax
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T30116[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30116[ebp]
	jmp	$LN19@uflow@2
...
; 467  : 							(size_t)(_Src - &*_Str.begin()));
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	edx, DWORD PTR __Src$26394[ebp]
	sub	edx, eax
	push	edx
	push	0
	lea	ecx, DWORD PTR __Str$26388[ebp]
...
; 477  : 					return (_Traits::to_int_type(_Ch));	// return result
	...
	call	?to_int_type@?$char_traits@D@std@@SAHABD@Z ; std::char_traits<char>::to_int_type
	add	esp, 4
	mov	DWORD PTR $T30119[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30119[ebp]
...
; 480  : 					return (_Traits::eof());	// conversion failed
	...
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30120[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$26388[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	eax, DWORD PTR $T30120[ebp]
	jmp	SHORT $LN19@uflow@2
$LN9@uflow@2:
...
; 546  : 			|| 0 <= fflush(_Myfile) ? 0 : -1);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T30168[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30169[ebp], eax
	lea	ecx, DWORD PTR $T30168[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30169[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 176  : 			_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	ecx, DWORD PTR [eax]
	add	ecx, 4
	mov	DWORD PTR __Pnext$12634[ebp], ecx
$LN3@Orphan_me:

; 177  : 			while (*_Pnext != 0 && *_Pnext != this)

	mov	eax, DWORD PTR __Pnext$12634[ebp]
	cmp	DWORD PTR [eax], 0
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$26621[ebp], ecx

; 1119 : 			_Eos(_Newsize);

	mov	eax, DWORD PTR __Newsize$26621[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 1352 : 		return (_STRING_ITERATOR(_Myptr()));
	...
	mov	ecx, DWORD PTR $T30238[ebp]
	or	ecx, 1
	mov	DWORD PTR $T30238[ebp], ecx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$26644[ebp], ecx
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	eax
	mov	ecx, DWORD PTR __Ptr$26644[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	add	edx, 4
	push	edx
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Ptr$26644[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
__Pnext$12646 = -32					; size = 4
__Lock$12645 = -20					; size = 4
_this$ = -8						; size = 4
...
; 198  : 		_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$12645[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 200  : 		for (_Iterator_base12 **_Pnext = &_Myproxy->_Myfirstiter;
	...
	mov	ecx, DWORD PTR [eax]
	add	ecx, 4
	mov	DWORD PTR __Pnext$12646[ebp], ecx
	jmp	SHORT $LN3@Orphan_all
$LN2@Orphan_all:

; 201  : 			*_Pnext != 0; *_Pnext = (*_Pnext)->_Mynextiter)

	mov	eax, DWORD PTR __Pnext$12646[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR __Pnext$12646[ebp]
...
; 319  : 			_THROW_NCEE(failure, "ios_base::failbit set");
	...
	push	1
	lea	eax, DWORD PTR $T30295[ebp]
	push	eax
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BG@FMKFHCIL@ios_base?3?3failbit?5set?$AA@
	lea	ecx, DWORD PTR $T30294[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	ecx, DWORD PTR $T30294[ebp]
	push	ecx
...
; 321  : 			_THROW_NCEE(failure, "ios_base::eofbit set");
	...
	push	1
	lea	eax, DWORD PTR $T30297[ebp]
	push	eax
	call	?make_error_code@std@@YA?AVerror_code@1@W4io_errc@31@@Z ; std::make_error_code
	add	esp, 8
	push	eax
	push	OFFSET ??_C@_0BF@OOHOMBOF@ios_base?3?3eofbit?5set?$AA@
	lea	ecx, DWORD PTR $T30296[ebp]
	call	??0failure@ios_base@std@@QAE@PBDABVerror_code@2@@Z ; std::ios_base::failure::failure
	push	OFFSET __TI4?AVfailure@ios_base@std@@
	lea	ecx, DWORD PTR $T30296[ebp]
	push	ecx
...
$T30350 = -264						; size = 4
$T30351 = -252						; size = 4
__Meta$26785 = -48					; size = 4
__Ctype_fac$26781 = -36					; size = 4
_this$ = -24						; size = 4
__$EHRec$ = -16						; size = 16
__Noskip$ = 8						; size = 1
...
; 124  : 				const _Ctype& _Ctype_fac = _USE(ios_base::getloc(), _Ctype);
	...
	add	esp, 4
	mov	DWORD PTR __Ctype_fac$26781[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+12], -1
	lea	ecx, DWORD PTR $T30350[ebp]
...
; 127  : 				int_type _Meta = _Myios::rdbuf()->sgetc();
	...
	mov	DWORD PTR __Meta$26785[ebp], eax
	jmp	SHORT $LN7@Ipfx
$LN6@Ipfx:
...
; 130  : 					if (_Traits::eq_int_type(_Traits::eof(), _Meta))
	...
	mov	DWORD PTR $T30351[ebp], eax
	lea	ecx, DWORD PTR __Meta$26785[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30351[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
...
; 136  : 						_Traits::to_char_type(_Meta)))
	...
	lea	eax, DWORD PTR __Meta$26785[ebp]
	push	eax
	call	?to_char_type@?$char_traits@D@std@@SADABH@Z ; std::char_traits<char>::to_char_type
	add	esp, 4
	...
	push	ecx
	push	72					; 00000048H
	mov	ecx, DWORD PTR __Ctype_fac$26781[ebp]
...
; 120  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$16929[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
; 123  : 				return (_Refs == 0 ? this : 0);
	...
	mov	DWORD PTR $T30373[ebp], ecx
	lea	ecx, DWORD PTR __Lock$16929[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T30373[ebp]
...
; 452  : 		return (*_Ploc);
	...
	mov	edx, DWORD PTR $T30387[ebp]
	or	edx, 1
	mov	DWORD PTR $T30387[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 112  : 			_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$16924[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
$LN5@snextc:
	...
	mov	DWORD PTR $T30406[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30407[ebp], eax
	lea	eax, DWORD PTR $T30406[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30407[ebp]
	push	ecx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	edx, al
...
; 939  : 		{	// construct from stream buffer pointer
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T30458[ebp]
	or	eax, 1
	mov	DWORD PTR $T30458[ebp], eax
$LN1@basic_iost:
	push	0
	push	0
...
__unwindfunclet$??0?$basic_iostream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@@Z$0:
	...
	and	eax, 1
	je	$LN5@basic_iost
	and	DWORD PTR $T30458[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 24					; 00000018H
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_iost:
...
_TEXT	SEGMENT
__Nw$27134 = -56					; size = 4
__Nr$27132 = -44					; size = 4
__Pn$27130 = -32					; size = 4
__Pb$27128 = -20					; size = 4
_this$ = -8						; size = 4
__File$ = 8						; size = 4
__Which$ = 12						; size = 4
...
; 574  : 			_Elem **_Pb = (_Elem **)&_File->_IOBASE;
	...
	mov	eax, DWORD PTR __File$[ebp]
	add	eax, 8
	mov	DWORD PTR __Pb$27128[ebp], eax

; 575  : 			_Elem **_Pn = (_Elem **)&_File->_IOPTR;

	mov	eax, DWORD PTR __File$[ebp]
	mov	DWORD PTR __Pn$27130[ebp], eax

; 576  : 			int *_Nr = (int *)&_File->_IORCNT;

	mov	eax, DWORD PTR __File$[ebp]
	add	eax, 4
	mov	DWORD PTR __Nr$27132[ebp], eax

; 577  : 			int *_Nw = (int *)&_File->_IOWCNT;

	mov	eax, DWORD PTR __File$[ebp]
	add	eax, 4
	mov	DWORD PTR __Nw$27134[ebp], eax

; 578  : 			_Mysb::_Init(_Pb, _Pn, _Nr, _Pb, _Pn, _Nw);

	mov	eax, DWORD PTR __Nw$27134[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pn$27130[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pb$27128[ebp]
	push	edx
	mov	eax, DWORD PTR __Nr$27132[ebp]
	push	eax
	mov	ecx, DWORD PTR __Pn$27130[ebp]
	push	ecx
	mov	edx, DWORD PTR __Pb$27128[ebp]
...
$T30510 = -313						; size = 1
$T30515 = -304						; size = 4
__Count$27159 = -100					; size = 4
__Str$27146 = -88					; size = 32
__Dest$27142 = -48					; size = 4
__STRING_INC$27141 = -36				; size = 4
_this$ = -24						; size = 4
__$ArrayPad$ = -16					; size = 4
__$EHRec$ = -12						; size = 12
...
; 592  : 			const int _STRING_INC = 8;
	...
	mov	DWORD PTR __STRING_INC$27141[ebp], 8
...
; 594  : 			if (_Traits::eq_int_type(_Traits::eof(), overflow()))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T30497[ebp], eax
	call	?eof@?$char_traits@D@std@@SAHXZ		; std::char_traits<char>::eof
	mov	DWORD PTR $T30498[ebp], eax
	lea	ecx, DWORD PTR $T30497[ebp]
	push	ecx
	lea	edx, DWORD PTR $T30498[ebp]
	push	edx
	call	?eq_int_type@?$char_traits@D@std@@SA_NABH0@Z ; std::char_traits<char>::eq_int_type
	add	esp, 8
	movzx	eax, al
...
; 597  : 			string _Str(_STRING_INC, '\0');
	...
	push	0
	push	8
	lea	ecx, DWORD PTR __Str$27146[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@ID@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
$LN11@Endwrite:
...
; 600  : 					&*_Str.begin(), &*_Str.begin() + _Str.size(), _Dest))
	...
	lea	eax, DWORD PTR __Dest$27142[ebp]
	push	eax
	lea	ecx, DWORD PTR $T30500[ebp]
	push	ecx
	lea	ecx, DWORD PTR __Str$27146[ebp]
	call	?begin@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE?AV?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@2@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::begin
	...
	mov	DWORD PTR $T30499[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	lea	ecx, DWORD PTR $T30501[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR $T30500[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
	mov	ecx, DWORD PTR $T30499[ebp]
...
; 607  : 					size_t _Count = _Dest - &*_Str.begin();
	...
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	mov	edx, DWORD PTR __Dest$27142[ebp]
	sub	edx, eax
	mov	DWORD PTR __Count$27159[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+8], 0
...
; 609  : 						fwrite(&*_Str.begin(), 1, _Count, _Myfile))
	...
	cmp	DWORD PTR __Count$27159[ebp], 0
	jbe	SHORT $LN18@Endwrite
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+84]
	push	ecx
	mov	edx, DWORD PTR __Count$27159[ebp]
	push	edx
	push	1
	...
	mov	BYTE PTR __$EHRec$[ebp+8], 4
	mov	edx, DWORD PTR $T30515[ebp]
	or	edx, 1
	mov	DWORD PTR $T30515[ebp], edx
	mov	ecx, DWORD PTR tv197[ebp]
	call	??D?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEAADXZ ; std::_String_iterator<char,std::char_traits<char>,std::allocator<char> >::operator*
	push	eax
	call	_fwrite
	add	esp, 16					; 00000010H
	cmp	DWORD PTR __Count$27159[ebp], eax
...
$LN19@Endwrite:
	...
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	ecx, DWORD PTR $T30515[ebp]
	and	ecx, 1
	je	SHORT $LN26@Endwrite
	and	DWORD PTR $T30515[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T30504[ebp]
	call	??1?$_String_iterator@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ
$LN26@Endwrite:
	movzx	edx, BYTE PTR $T30503[ebp]
	test	edx, edx
	je	SHORT $LN5@Endwrite

; 610  : 						return (false);	// write failed

	mov	BYTE PTR $T30507[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$27146[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T30507[ebp]
	jmp	$LN16@Endwrite
$LN5@Endwrite:
...
; 612  : 						return (true);
	...
	mov	BYTE PTR $T30508[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$27146[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T30508[ebp]
...
; 619  : 					return (true);	// nothing to do
	...
	mov	BYTE PTR $T30509[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Str$27146[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	al, BYTE PTR $T30509[ebp]
	jmp	SHORT $LN16@Endwrite
$LN1@Endwrite:
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T30561[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T30561[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 54   : 	__CLR_OR_THIS_CALL basic_ostream(_Uninitialized, bool _Addit = true)
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T30580[ebp]
	or	eax, 1
	mov	DWORD PTR $T30580[ebp], eax
$LN2@basic_ostr:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR [ecx+4]
...
__unwindfunclet$??0?$basic_ostream@DU?$char_traits@D@std@@@std@@QAE@W4_Uninitialized@1@_N@Z$0:
	...
	and	eax, 1
	je	$LN8@basic_ostr
	and	DWORD PTR $T30580[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 8
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN8@basic_ostr:
...
; 33   : 		{	// construct from stream buffer pointer
	...
	call	??0?$basic_ios@DU?$char_traits@D@std@@@std@@IAE@XZ ; std::basic_ios<char,std::char_traits<char> >::basic_ios<char,std::char_traits<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	mov	eax, DWORD PTR $T30593[ebp]
	or	eax, 1
	mov	DWORD PTR $T30593[ebp], eax
$LN1@basic_istr:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	edx, DWORD PTR [ecx+4]
...
__unwindfunclet$??0?$basic_istream@DU?$char_traits@D@std@@@std@@QAE@PAV?$basic_streambuf@DU?$char_traits@D@std@@@1@_N@Z$0:
	...
	and	eax, 1
	je	$LN5@basic_istr
	and	DWORD PTR $T30593[ebp], -2		; fffffffeH
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 16					; 00000010H
	jmp	??1?$basic_ios@DU?$char_traits@D@std@@@std@@UAE@XZ ; std::basic_ios<char,std::char_traits<char> >::~basic_ios<char,std::char_traits<char> >
$LN5@basic_istr:
...
; 25   : 		{	// construct with no buffers
	...
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T30604[ebp], eax
	cmp	DWORD PTR $T30604[ebp], 0
	je	SHORT $LN3@basic_stre
	mov	ecx, DWORD PTR $T30604[ebp]
...
; 130  : 		return (*_Plocale);
	...
	mov	ecx, DWORD PTR ___$ReturnUdt$[ebp]
	call	??0locale@std@@QAE@ABV01@@Z		; std::locale::locale
	mov	edx, DWORD PTR $T30619[ebp]
	or	edx, 1
	mov	DWORD PTR $T30619[ebp], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 564  : 		_Ploc = _NEW_CRT locale;
	...
	call	??2@YAPAXIABU_DebugHeapTag_t@std@@PADH@Z ; operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T30672[ebp], eax
	cmp	DWORD PTR $T30672[ebp], 0
	je	SHORT $LN3@Init@2
	mov	ecx, DWORD PTR $T30672[ebp]
	call	??0locale@std@@QAE@XZ			; std::locale::locale
...
_TEXT	SEGMENT
__Lock$12624 = -44					; size = 4
__Parent_proxy$12622 = -32				; size = 4
_this$ = -20						; size = 4
__$EHRec$ = -12						; size = 12
__Parent$ = 8						; size = 4
...
; 139  : 			_Container_proxy *_Parent_proxy = _Parent->_Myproxy;
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR __Parent_proxy$12622[ebp], ecx
...
; 142  : 			if (_Myproxy != _Parent_proxy)
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	cmp	ecx, DWORD PTR __Parent_proxy$12622[ebp]
	je	SHORT $LN3@Adopt
...
; 144  : 				_Lockit _Lock(_LOCK_DEBUG);
	...
	push	3
	lea	ecx, DWORD PTR __Lock$12624[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 146  : 				_Mynextiter = _Parent_proxy->_Myfirstiter;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Parent_proxy$12622[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [eax+4], edx

; 147  : 				_Parent_proxy->_Myfirstiter = this;

	mov	eax, DWORD PTR __Parent_proxy$12622[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+4], ecx
...
$T30727 = -292						; size = 12
$T30728 = -272						; size = 4
__Pfmod$27844 = -68					; size = 4
__Pf$27828 = -56					; size = 4
__Id$27827 = -44					; size = 4
__Psave$27815 = -32					; size = 4
__Lock$27814 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$27814[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$27815[ebp], eax
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$27815[ebp], 0
	je	SHORT $LN4@use_facet

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	eax, DWORD PTR __Psave$27815[ebp]
	mov	DWORD PTR __Pf$27828[ebp], eax
	jmp	SHORT $LN5@use_facet
$LN4@use_facet:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$27815[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	lea	ecx, DWORD PTR $T30727[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	eax, DWORD PTR $T30727[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	eax, DWORD PTR __Psave$27815[ebp]
	mov	DWORD PTR __Pfmod$27844[ebp], eax

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$27844[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$27828[ebp]
	mov	DWORD PTR $T30728[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$27814[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T30728[ebp]
$LN8@use_facet:
...
; 78   : 				_BEGIN_LOCK(_LOCK_LOCALE)
	...
	push	0
	lea	ecx, DWORD PTR __Lock$16918[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
...
$LN5@Getcat:
	...
	mov	DWORD PTR $T30757[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	edx, DWORD PTR __Ppf$[ebp]
	mov	eax, DWORD PTR $T30757[ebp]
	mov	DWORD PTR [edx], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T30764[ebp]
	and	ecx, 1
	je	SHORT $LN1@Getcat
	and	DWORD PTR $T30764[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T30760[ebp]
...
; 78   :             _THROW_NCEE(runtime_error, "bad locale name");
	...
	lea	ecx, DWORD PTR $T30776[ebp]
	call	??0runtime_error@std@@QAE@PBD@Z		; std::runtime_error::runtime_error
	push	OFFSET __TI2?AVruntime_error@std@@
	lea	eax, DWORD PTR $T30776[ebp]
	push	eax
	call	__CxxThrowException@8
$LN1@Locinfo:
...
; 118  : 		return (::_Getctype());
	...
	lea	eax, DWORD PTR $T30838[ebp]
	push	eax
	call	__Getctype
	add	esp, 4
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T30837[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR $T30837[ebp+4], edx
	mov	ecx, DWORD PTR [eax+8]
	mov	DWORD PTR $T30837[ebp+8], ecx
	mov	edx, DWORD PTR [eax+12]
	mov	DWORD PTR $T30837[ebp+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
	mov	ecx, DWORD PTR $T30837[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR $T30837[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR $T30837[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR $T30837[ebp+12]
	mov	DWORD PTR [eax+12], edx
	mov	eax, DWORD PTR ___$ReturnUdt$[ebp]
...
; 2408 : 			delete[] (void *)_Ctype._Table;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+16]
	mov	DWORD PTR $T30868[ebp], ecx
	mov	edx, DWORD PTR $T30868[ebp]
	push	edx
...
$T30888 = -292						; size = 12
$T30889 = -272						; size = 4
__Pfmod$28047 = -68					; size = 4
__Pf$28036 = -56					; size = 4
__Id$28035 = -44					; size = 4
__Psave$28023 = -32					; size = 4
__Lock$28022 = -20					; size = 4
__$EHRec$ = -12						; size = 12
__Loc$ = 8						; size = 4
...
; 505  : 	_BEGIN_LOCK(_LOCK_LOCALE)	// the thread lock, make get atomic
	...
	push	0
	lea	ecx, DWORD PTR __Lock$28022[ebp]
	call	??0_Lockit@std@@QAE@H@Z			; std::_Lockit::_Lockit
	mov	DWORD PTR __$EHRec$[ebp+8], 0
...
; 507  : 			_Facetptr<_Facet>::_Psave;	// static pointer to lazy facet
	...
	mov	DWORD PTR __Psave$28023[ebp], eax
...
; 509  : 		size_t _Id = _Facet::id;
	...
	call	??Bid@locale@std@@QAEIXZ		; std::locale::id::operator unsigned int
	mov	DWORD PTR __Id$28035[ebp], eax

; 510  : 		const locale::facet *_Pf = _Loc._Getfacet(_Id);

	mov	eax, DWORD PTR __Id$28035[ebp]
	push	eax
	mov	ecx, DWORD PTR __Loc$[ebp]
	call	?_Getfacet@locale@std@@QBEPBVfacet@12@I@Z ; std::locale::_Getfacet
	mov	DWORD PTR __Pf$28036[ebp], eax

; 511  : 
; 512  : 		if (_Pf != 0)

	cmp	DWORD PTR __Pf$28036[ebp], 0
...
; 514  : 		else if (_Psave != 0)
	...
	cmp	DWORD PTR __Psave$28023[ebp], 0
	je	SHORT $LN4@use_facet@2

; 515  : 			_Pf = _Psave;	// lazy facet already allocated

	mov	eax, DWORD PTR __Psave$28023[ebp]
	mov	DWORD PTR __Pf$28036[ebp], eax
	jmp	SHORT $LN5@use_facet@2
$LN4@use_facet@2:
...
; 516  : 		else if (_Facet::_Getcat(&_Psave, &_Loc) == (size_t)(-1))
	...
	mov	eax, DWORD PTR __Loc$[ebp]
	push	eax
	lea	ecx, DWORD PTR __Psave$28023[ebp]
	push	ecx
...
; 520  : 			_THROW_NCEE(bad_cast, _EMPTY_ARGUMENT);	// lazy disallowed
	...
	push	OFFSET ??_C@_08EPJLHIJG@bad?5cast?$AA@
	lea	ecx, DWORD PTR $T30888[ebp]
	call	??0bad_cast@std@@QAE@PBD@Z		; std::bad_cast::bad_cast
	push	OFFSET __TI2?AVbad_cast@std@@
	lea	eax, DWORD PTR $T30888[ebp]
	push	eax
	call	__CxxThrowException@8
...
; 531  : 			locale::facet *_Pfmod = (_Facet *)_Psave;
	...
	mov	eax, DWORD PTR __Psave$28023[ebp]
	mov	DWORD PTR __Pfmod$28047[ebp], eax

; 532  : 			_Pfmod->_Incref();

	mov	ecx, DWORD PTR __Pfmod$28047[ebp]
	call	?_Incref@facet@locale@std@@QAEXXZ	; std::locale::facet::_Incref
...
; 536  : 		return ((const _Facet&)(*_Pf));	// should be dynamic_cast
	...
	mov	eax, DWORD PTR __Pf$28036[ebp]
	mov	DWORD PTR $T30889[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __Lock$28022[ebp]
	call	??1_Lockit@std@@QAE@XZ			; std::_Lockit::~_Lockit
	mov	eax, DWORD PTR $T30889[ebp]
$LN8@use_facet@2:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T30910[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T30910[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T30919[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T30919[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate@2:
...
; 852  : 				_Locinfo(_Ploc->c_str()));
	...
	call	?_DebugHeapTag_func@std@@YAABU_DebugHeapTag_t@1@XZ ; std::_DebugHeapTag_func
	mov	DWORD PTR $T30929[ebp], eax
	push	851					; 00000353H
	push	OFFSET ??_C@_0EH@NEEAIMIH@c?3?2program?5files?5?$CIx86?$CJ?2microsoft@
	mov	eax, DWORD PTR $T30929[ebp]
	push	eax
	push	8
	call	??2facet@locale@std@@SAPAXIABU_DebugHeapTag_t@2@PADH@Z ; std::locale::facet::operator new
	add	esp, 16					; 00000010H
	mov	DWORD PTR $T30928[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T30928[ebp], 0
	je	SHORT $LN4@Getcat@2
	push	0
	mov	ecx, DWORD PTR __Ploc$[ebp]
	call	?c_str@locale@std@@QBEPBDXZ		; std::locale::c_str
	push	eax
	lea	ecx, DWORD PTR $T30930[ebp]
	call	??0_Locinfo@std@@QAE@PBD@Z		; std::_Locinfo::_Locinfo
	mov	DWORD PTR tv138[ebp], eax
	mov	ecx, DWORD PTR tv138[ebp]
	mov	DWORD PTR tv133[ebp], ecx
	mov	BYTE PTR __$EHRec$[ebp+8], 1
	mov	edx, DWORD PTR $T30934[ebp]
	or	edx, 1
	mov	DWORD PTR $T30934[ebp], edx
	mov	eax, DWORD PTR tv133[ebp]
	push	eax
	mov	ecx, DWORD PTR $T30928[ebp]
...
$LN5@Getcat@2:
	mov	ecx, DWORD PTR tv92[ebp]
	mov	DWORD PTR $T30927[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], 2
	mov	edx, DWORD PTR __Ppf$[ebp]
	mov	eax, DWORD PTR $T30927[ebp]
	mov	DWORD PTR [edx], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T30934[ebp]
	and	ecx, 1
	je	SHORT $LN1@Getcat@2
	and	DWORD PTR $T30934[ebp], -2		; fffffffeH
	lea	ecx, DWORD PTR $T30930[ebp]
	call	??1_Locinfo@std@@QAE@XZ			; std::_Locinfo::~_Locinfo
$LN1@Getcat@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T30947[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T30947[ebp], 0
	...
	mov	ecx, DWORD PTR $T30947[ebp]
	mov	DWORD PTR [ecx], edx
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR $T30947[ebp]
