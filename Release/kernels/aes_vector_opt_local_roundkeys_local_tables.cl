#ifndef _AES_VECTOR_OPT_LOCAL_ROUNDKEYS_LOCAL_TABLES_CL
#define _AES_VECTOR_OPT_LOCAL_ROUNDKEYS_LOCAL_TABLES_CL



__kernel void aes_vector_opt_local_roundkeys_local_tables(
