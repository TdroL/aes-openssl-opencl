#ifndef _AES_ENCRYPT_VECTOR_192_LOCAL_CL
#define _AES_ENCRYPT_VECTOR_192_LOCAL_CL

#include "aes_encrypt_tables.cl"
#include "aes_encrypt_vector.cl"

__kernel void aes_encrypt_vector_192_local(__global uint4 *state, __constant uint4 *roundkeys) {
