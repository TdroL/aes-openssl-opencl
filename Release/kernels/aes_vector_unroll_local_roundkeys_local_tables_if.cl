#ifndef _AES_VECTOR_UNROLL_LOCAL_ROUNDKEYS_LOCAL_TABLES_IF_CL
#define _AES_VECTOR_UNROLL_LOCAL_ROUNDKEYS_LOCAL_TABLES_IF_CL



__kernel void aes_vector_unroll_local_roundkeys_local_tables_if(
