#ifndef _AES_ENCRYPT_VECTOR_256_LOCAL_CL
#define _AES_ENCRYPT_VECTOR_256_LOCAL_CL

#include "aes_encrypt_tables.cl"
#include "aes_encrypt_vector.cl"

__kernel void aes_encrypt_vector_256_local(__global uint4 *state, __constant uint4 *roundkeys) {
